...
public class EmployeesServiceImpl implements EmployeesService{
    ...
    public void modify(EmployeesDTO employeesDTO){
        ...
        Employees employees = result.orElseThrow();
        employees.change(employeesDTO.getEmployeeid(), employeesDTO.getEmployeename(), employeesDTO.getPassword(), employeesDTO.getHiredate(), employeesDTO.getTerminationdate(), employeesDTO.getDepartment(), employeesDTO.getPosition(), employeesDTO.getContactnumber(), employeesDTO.getRole());
